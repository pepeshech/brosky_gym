...
export const AthleteProfileSchema = z.object({
  ...
  autoPilotAggressiveness: z.enum(['conservative', 'balanced', 'hardcore']).optional(),
  autoPilotPlateStep: z.number().positive().optional(),
  autoPilotMode: z.enum(['autofill', 'hints']).optional(),
  useLocalLlm: z.boolean().optional(),
  llmAdviceDetail: z.enum(['concise', 'detailed', 'math_only']).optional(),
}).passthrough();
