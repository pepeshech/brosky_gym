    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-xs"
          onClick={onClose}
        >
          <motion.div
            key="smart-advisor-container"
            ...
            className="relative w-full max-w-lg bg-white rounded-3xl border border-gym-border/50 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
